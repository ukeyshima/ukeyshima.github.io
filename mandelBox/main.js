window.addEventListener("load", function () {
    ...
    uniLocation[2] = gl.getUniformLocation(prg, "cameraPos");
    uniLocation[3] = gl.getUniformLocation(prg, "cameraDir");
    uniLocation[4] = gl.getUniformLocation(prg, "cameraUp");
    ...
    gl.uniform3fv(uniLocation[2], cPos);
    gl.uniform3fv(uniLocation[3], cDir);
    gl.uniform3fv(uniLocation[4], cUp);
