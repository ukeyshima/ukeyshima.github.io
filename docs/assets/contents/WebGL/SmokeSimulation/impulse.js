class Impulse {
  constructor(webgl2, frag) {
    ...
    const uniList = ['sourceTexture', 'fill', 'texelSizeInverse', 'time'];
  ...
  execute(sourceFrameBuffer, outputFrameBuffer, fill, time) {
    ...
    this.webgl2.gl.uniform1f(this.webgl2.webglPrograms.impulseProgram.uniLocations.time, time);
