...
const webGLStart = (canvas, gl, shader) => {
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(cubeAttribute.p),
    gl.STATIC_DRAW
  );
  ...
  gl.bufferData(
    ...
    new Int16Array(cubeAttribute.i),
    gl.STATIC_DRAW
  );
  ...
  const sphereProgram = create_program(
    create_shader(shader[4], gl.VERTEX_SHADER),
    create_shader(shader[5], gl.FRAGMENT_SHADER),
    false
  );
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(sphereAttribute.p),
    gl.STATIC_DRAW
  );
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(sphereAttribute.n),
    gl.STATIC_DRAW
  );
  ...
  gl.bufferData(
    gl.ELEMENT_ARRAY_BUFFER,
    new Int16Array(sphereAttribute.i),
    gl.DYNAMIC_COPY
  );
  ...
  horizontalGaussianUniLocation[0] = gl.getUniformLocation(
    horizontalGaussianProgram,
    "texture"
  );
  horizontalGaussianUniLocation[1] = gl.getUniformLocation(
    horizontalGaussianProgram,
    "resolution"
  );
  horizontalGaussianUniLocation[2] = gl.getUniformLocation(
    horizontalGaussianProgram,
    "weight"
  );
  ...
  horizontalGaussianAttLocation[0] = gl.getAttribLocation(
    horizontalGaussianProgram,
    "position"
  );
  horizontalGaussianAttStride[0] = 3;
  horizontalGaussianAttLocation[1] = gl.getAttribLocation(
    horizontalGaussianProgram,
    "textureCoord"
  );
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(gaussianPosition),
    gl.STATIC_DRAW
  );
  gl.enableVertexAttribArray(horizontalGaussianAttLocation[0]);
  gl.vertexAttribPointer(
    horizontalGaussianAttLocation[0],
    horizontalGaussianAttStride[0],
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(gaussianTextureCoord),
    gl.STATIC_DRAW
  );
  gl.enableVertexAttribArray(horizontalGaussianAttLocation[1]);
  gl.vertexAttribPointer(
    horizontalGaussianAttLocation[1],
    horizontalGaussianAttStride[1],
    gl.FLOAT,
    false,
    0,
    0
  ...
  verticalGaussianUniLocation[0] = gl.getUniformLocation(
    verticalGaussianProgram,
    "texture"
  );
  verticalGaussianUniLocation[1] = gl.getUniformLocation(
    verticalGaussianProgram,
    "resolution"
  );
  verticalGaussianUniLocation[2] = gl.getUniformLocation(
    verticalGaussianProgram,
    "weight"
  );
  ...
  verticalGaussianAttLocation[0] = gl.getAttribLocation(
    verticalGaussianProgram,
    "position"
  );
  verticalGaussianAttStride[0] = 3;
  verticalGaussianAttLocation[1] = gl.getAttribLocation(
    verticalGaussianProgram,
    "textureCoord"
  );
  ...
  gl.vertexAttribPointer(
    verticalGaussianAttLocation[0],
    verticalGaussianAttStride[0],
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    verticalGaussianAttLocation[1],
    verticalGaussianAttStride[1],
    gl.FLOAT,
    false,
    0,
    0
  ...
  const render = () => {
    ...
    gl.bindVertexArray(null);
    eyePosition[0] = 30.0 * Math.sin(time / 10.0);
    eyePosition[2] = 30.0 * Math.cos(time / 10.0);
    //viewPoint[0] = Math.sin(time/10.0);
    //viewPoint[2]=Math.cos(time/10.0);
    ...
    gl.uniform2fv(horizontalGaussianUniLocation[1], [
      canvas.width,
      canvas.height
    ]);
    ...
    gl.bindVertexArray(verticalGaussianVao);
    gl.activeTexture(gl.TEXTURE0);
    gl.bindTexture(gl.TEXTURE_2D, fBuffer[1].t);
    gl.uniform1i(verticalGaussianUniLocation[0], 0);
    gl.uniform2fv(verticalGaussianUniLocation[1], [
      canvas.width,
      canvas.height
    ]);
    gl.uniform1fv(verticalGaussianUniLocation[2], weight);
    gl.drawElements(gl.TRIANGLES, gaussianIndex.length, gl.UNSIGNED_SHORT, 0);
    gl.bindVertexArray(null);
    ...
    gl.drawElementsInstanced(
      gl.TRIANGLES,
      new Int16Array(sphereAttribute.i).length,
      gl.UNSIGNED_SHORT,
      0,
      particleNum
    );
