...
import css from './experiment2/style.txt';
import html from './experiment2/index.txt';
import js from './experiment2/main.txt';
...
@observer
export default class ExperimentButton2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      fontColor: '#000'
